...
project/
  data/
    raw/adressa_one_week/               # 原始数据
    base/adressa_one_week_mind_base/    # 基线对照数据
    work/adressa_one_week_mind_final/   # 实验/工作目录（默认 DATA_ROOT）
    mind/MINDsmall/                     # MIND 预训练向量
    mind/MINDlarge/
  outputs/
    artifacts/                          # 中间产物/训练输出
    cache/                              # Wikidata + HuggingFace 缓存
  configs/
    sweep_grid.seen_first.json
    sweep_grid_100runs.seen_first.json
  scripts/
